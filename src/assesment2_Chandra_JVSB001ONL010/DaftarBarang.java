...
public class DaftarBarang {
	...
	public HashMap<Integer, Barang> getDaftarBarang() {
		Barang barang1 = new Barang(1, "Mouse Bluetooth 5.0", 149999, 0.1);
		Barang barang2 = new Barang(2, "Headphone Eksternal", 246000, 0.05);
		Barang barang3 = new Barang(3, "Power Bank 10.000 mAh", 136000);
		Barang barang4 = new Barang(4, "Tripod Kamera", 267999, 0.2);
		Barang barang5 = new Barang(5, "Smart Watch Xiaomi", 899000, 0.1);
